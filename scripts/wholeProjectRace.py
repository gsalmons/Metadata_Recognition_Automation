...
try:
    for train_index, test_index in skf.split(xRandomSample, yTruthList):
        ...
        plt.grid(True)
        plt.show()
        plt.savefig(f'/results/raceProject/precision_recall_curve_allsub_{foldNumber}.png')
...
plt.grid(True)
plt.show()
plt.savefig('/results/raceProject/precision_recall_curve.png')
...
plt.savefig('/results/raceProject/confusion_matrix_allsub.png')
plt.show()
...
plt.tight_layout()
plt.savefig('/results/raceProject/mostRelevantNgrams_allsub.png')
plt.show()
...
with open("/results/raceProject/ngramFrequencyByCategory.tsv", "w") as writeFile:
...
plt.grid(True)
plt.show()
plt.savefig(f'/results/raceProject/precision_recall_curve_{numTop}_removed.png')
...
disp.plot(cmap='Blues', values_format='d')
plt.title('Confusion Matrix')
plt.savefig(f'/results/raceProject/confusion_matrix_removed_top{numTop}.png')
plt.show()