...
for metadataFocus in ["race", "sex", "tumor_stage"]:
    ...
    try:
        for train_index, test_index in skf.split(xRandomSample, yTruthList):
            ...
            plt.grid(True)
            plt.show()
            plt.savefig(f'/results/project/embedding/{metadataFocus}/precision_recall_curve_allsub_{foldNumber}.png')
    ...
    plt.grid(True)
    plt.show()
    plt.savefig(f'/results/project/embedding/{metadataFocus}/precision_recall_curve.png')

    with open(f"/results/project/embedding/{metadataFocus}/projectEmbeddingConfidencesallsub.tsv", "w") as writeFile:
    ...
    plt.savefig(f'/results/project/embedding/{metadataFocus}/confusion_matrix_allsub.png')
    plt.show()