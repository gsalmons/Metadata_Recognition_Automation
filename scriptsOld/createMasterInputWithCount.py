"""Objectives: Create a file that could be the input for machine learning. Record the occurence
...
Outputs: masterCountInputOracle.tsv
"""
...
with open("/bioProjectIds/masterCountInputOracle.tsv", "w") as writeFile:
