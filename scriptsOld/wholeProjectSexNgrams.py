...
yTruthDict = dict() 
with open("/files/sexLabeled.tsv", "r") as readFile:
...
#Load the input data
with open("/files/masterInputOracle.tsv", "r") as readFile:
    header = readFile.readline()
...
try:
    for train_index, test_index in skf.split(xRandomSample, yTruthList):
        ...
        plt.grid(True)
        plt.show() 
        plt.savefig(f'/results/projectSexNgrams/precision_recall_curve_allsub_{foldNumber}.png')
...
with open("/results/kFoldTsvs/projectSexNgramconfidencesallsub.tsv", "w") as writeFile:
...
plt.grid(True)
plt.show()
plt.savefig('/results/projectSexNgrams/precision_recall_curve.png')
...
plt.savefig('/results/projectSexNgrams/confusion_matrix_allsub.png')
plt.show()
...
plt.tight_layout()
plt.savefig('/results/projectSexNgrams/mostRelevantNgrams_allsub.png')
plt.show()
...
with open("/results/projectSexNgrams/ngramFrequencyByCategory.tsv", "w") as writeFile:
...
plt.grid(True)
plt.show()
plt.savefig(f'/results/projectSexNgrams/precision_recall_curve_{numTop}_removed.png')
...
disp.plot(cmap='Blues', values_format='d')
plt.title('Confusion Matrix')
plt.savefig(f'/results/projectSexNgrams/confusion_matrix_removed_top{numTop}.png')
plt.show()