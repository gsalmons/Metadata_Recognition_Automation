...
print(len(xRandomSample))
print(len(yTruthList))
print(len(bioProjectList))
...
for train_index, test_index in skf.split(xRandomSample, yTruthList):
    ...
    plt.grid(True)
    plt.show() 
    plt.savefig(f'/results/projectTumorNgrams/precision_recall_curve_allsub_{foldNumber}.png')
...
with open("/results/kFoldTsvs/projectTumorNgramconfidencesallsub.tsv", "w") as writeFile:
...
plt.grid(True)
plt.show()
plt.savefig('/results/projectTumorNgrams/precision_recall_curve.png')
...
plt.savefig('/results/projectTumorNgrams/confusion_matrix_allsub.png')
plt.show()
...
plt.tight_layout()
plt.savefig('/results/projectTumorNgrams/mostRelevantNgrams_allsub.png')
plt.show()

#Save the ngrams by importance with their frequencies in tumor stage and nontumor stage. 
...
with open("/results/projectTumorNgrams/ngramFrequencyByCategory.tsv", "w") as writeFile:
    writeFile.write("Importance\tNgram\tFrequency in Tumor Stage Projects\tFrequency in NonTumor Stage Projects\n")
...
plt.grid(True)
plt.show()
plt.savefig(f'/results/projectTumorNgrams/precision_recall_curve_{numTop}_removed.png')
...
disp.plot(cmap='Blues', values_format='d')
plt.title('Confusion Matrix')
plt.savefig(f'/results/projectTumorNgrams/confusion_matrix_removed_top{numTop}.png')
plt.show()