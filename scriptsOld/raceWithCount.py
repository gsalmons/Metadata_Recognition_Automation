...
#Load the input data
with open("/bioProjectIds/masterCountInputOracle.tsv", "r") as readFile:
    header = readFile.readline()
...
try:
    for train_index, test_index in skf.split(xRandomSample, yTruthList):
        ...
        plt.grid(True)
        plt.show()
        plt.savefig(f'/results/counts/precision_recall_curve_allsub_{foldNumber}.png')
...
with open("/results/kFoldTsvs/countConfidencesallsub.tsv", "w") as writeFile:
...
plt.grid(True)
plt.show()
plt.savefig('/results/counts/precision_recall_curve.png')
...
plt.savefig('/results/counts/confusion_matrix_allsub.png')
plt.show()
...
plt.tight_layout()
plt.savefig('/results/counts/mostRelevantNgrams_allsub.png')
plt.show()
...
with open("/results/counts/ngramFrequencyByCategory.tsv", "w") as writeFile:
...
plt.grid(True)
plt.show()
plt.savefig(f'/results/counts/precision_recall_curve_{numTop}_removed.png')
...
disp.plot(cmap='Blues', values_format='d')
plt.title('Confusion Matrix')
plt.savefig(f'/results/counts/confusion_matrix_removed_top{numTop}.png')
plt.show()